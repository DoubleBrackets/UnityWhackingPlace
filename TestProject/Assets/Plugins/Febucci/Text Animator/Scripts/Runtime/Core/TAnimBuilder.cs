...
namespace Febucci.UI.Core
{
    ...
    public static class TAnimBuilder
    {
        ...
        static Dictionary<string, Type> behaviorsData = new();
        static Dictionary<string, Type> appearancesData = new();

        static HashSet<string> globalDefaultActions = new();
        static HashSet<string> globalCustomActions = new();
