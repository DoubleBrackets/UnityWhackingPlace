...
namespace Febucci.UI.Core.Editors
{
    ...
    class TextAnimatorDrawer : Editor
    {
        ...
        static readonly Color errorColor = new(1, .6f, .6f);
        static readonly Color selectedShowColor = new(.7f, 1, .7f);
        static readonly Color sectionsColor = new(.95f, .95f, .95f);

        static GUIStyle boldFoldout = new();
        ...
        GUIContent easyIntegrationLabel = new("Use Easy Integration");
        ...
        GUIContent scriptableBuiltin_GUI = new("Shared Values");
