...
namespace Febucci.UI.Core
{
    ...
    public abstract class EffectsBase
    {
        ...
        [Obsolete("This value will be removed from next versions. Please use 'uniformIntensity' instead")] public float effectIntensity => uniformIntensity;
        ...
        internal class RegionManager
        {
            ...
            List<TextRegion> textRegions = new();
        ...
        List<Modifier> modifiers { get; set; } = new();
