...
namespace Febucci.UI
{
    ...
    public class TextAnimator : MonoBehaviour
    {
        ...
        AppearancesContainer appearancesContainer = new();

        [SerializeField] string[] tags_fallbackBehaviors = new string[0];
        [SerializeField] BehaviorDefaultValues behaviorValues = new();
...
#pragma warning restore 0649
        ...
        List<BehaviorBase> behaviorEffects = new();
        List<AppearanceBase> appearanceEffects = new();
        List<AppearanceBase> disappearanceEffects = new();
        AppearanceBase[] fallbackAppearanceEffects;
        AppearanceBase[] fallbackDisappearanceEffects;
        BehaviorBase[] fallbackBehaviorEffects;

        List<InternalAction> typewriterActions = new();
        List<EventMarker> eventMarkers = new();
        ...
        Dictionary<string, Type> localBehaviors = new();
        Dictionary<string, Type> localAppearances = new();
        ...
        List<int> temp_effectsToApply = new(); //temporary
